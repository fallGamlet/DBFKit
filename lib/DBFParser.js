...
(function() {
  ...
  DBFParser = (function(_super) {
    ...
    DBFParser.prototype._parseHead = function(buffer) {
      ...
      this.fields = (function() {
        ...
        for (i = _i = 32, _ref = this.headOffset - 32; _i <= _ref; i = _i += 32) {
          field = {
            name: iconv.decode(buffer.slice(i, i + 11), this.encoding).toString().replace(/[\u0000].*$/, '').replace(/^[\r]+|[\n]+|[\r\n]+|[\n\r]+/, ''),
    ...
    DBFParser.prototype._parseRecords = function(buffer) {
      var bufferLength, bufferTemp, curPoint, endPoint, field, i, is_deleted, point, record, _i, _j, _len, _ref, _ref1, _ref2, _results;
      endPoint = this.headOffset + this.recordLength * this.recordsCount - 1;
      bufferLength = buffer.length;
      bufferTemp = null;
      _results = [];
      for (point = _i = _ref = this.headOffset, _ref1 = this.recordLength; _ref <= endPoint ? _i <= endPoint : _i >= endPoint; point = _i += _ref1) {
    ...
    DBFParser.prototype._parseField = function(begin, end, field, buffer) {
      ...
      switch (field.type) {
        case 'C':
          value = iconv.decode(buffer.slice(begin, end), this.encoding).toString().replace(/^\x20+|\x20+$/g, '');
          if (value) {
