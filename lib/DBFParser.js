...
(function() {
  ...
  DBFParser = (function(_super) {
    ...
    DBFParser.prototype._parseRecords = function(buffer) {
      var bufferLength, bufferTemp, curPoint, endPoint, field, i, is_deleted, point, record, tmpField, _i, _j, _len, _ref, _ref1, _ref2, _results;
      ...
      for (point = _i = _ref = this.headOffset, _ref1 = this.recordLength; _ref1 > 0 ? _i <= endPoint : _i >= endPoint; point = _i += _ref1) {
        ...
        for (_j = 0, _len = _ref2.length; _j < _len; _j++) {
          ...
          if (field.name === '') {
            ...
            tmpField = this._parseField(curPoint, curPoint += field.length, field, bufferTemp);
